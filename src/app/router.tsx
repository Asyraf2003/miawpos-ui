...
export function AppRouter() {
  ...
  return <Routes>
    ...
    <Route element={principal ? <AppShell /> : <Navigate to="/login" replace />}>
      <Route path="account" element={<AccountPage />} />
      {['root/new', 'root/select', 'app', 'app/catalog/new', 'app/catalog/:itemId', 'app/sales/:saleId'].map(path => <Route key={path} path={path} element={<RootPage />} />)}
    </Route>
